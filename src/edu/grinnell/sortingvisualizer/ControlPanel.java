...
public class ControlPanel extends JPanel {
     ...
     * @param arrayList the array to sort
     * @return the list sorting events generated by sorting the array
     */
    private static List<SortEvent<Integer>> generateEvents(String sort, ArrayList<Integer> arrayList) {
        switch (sort) {
        case "Selection":
            return Sorts.selectionSort(arrayList);
        case "Insertion":
            return Sorts.insertionSort(arrayList);
        case "Bubble":
            return Sorts.customSort(arrayList);
        case "Merge":
            return Sorts.mergeSort(arrayList);
        case("Quick"):
            return Sorts.quickSort(arrayList);
        default:
    ...
    public ControlPanel(NoteIndices notes, ArrayPanel panel) {
        ...
        playButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                ArrayList<SortEvent<Integer>> compareEvents = new ArrayList<>();
                for(int i = 0; i < notes.getNotes().size() - 1; i++) {
                	compareEvents.add(new CompareEvent<Integer>(i, i + 1));
                }
                
                @SuppressWarnings("unchecked")
                List<SortEvent<Integer>> events = generateEvents(sorts.getSelectedItem().toString(), (ArrayList<Integer>)notes.getNotes().clone());
